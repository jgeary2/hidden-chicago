// Sourced from https://github.com/visgl/react-google-maps/blob/main/examples/geometry/README.md
 ...
 */
export const CustomPolygon = forwardRef((props: PolygonProps, ref: PolygonRef) => {
