...
export const PointsOfInterest = () => {
    ...
    useEffect(() => {
        const displayedPOIs = [];
        displayedPOIs.push(getMapPointsFromJsonData(tiedHouseJson, mapFilters.tiedHouses, 'tiedHouses'));
        ...
        displayedPOIs.push(getMapPolygonsFromJsonData(neighborhoodJson, mapFilters.neighborhoods, 'neighborhoods'));
